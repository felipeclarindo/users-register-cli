...
class Main:
    def __init__(self) -> None:
        ...
        self.database:list[tuple] = [
            ...
            ("pedro", "usuario", "fglpc2@gmail.com", "Felipe", None, "013025086123", "13/02/2006", "123", "Rua luis porrio, 415", "user"),
            ("lucas", "usuario", "fglpc2@gmail.com", "Felipe", None, "013025086123", "13/02/2006", "123", "Rua luis porrio, 415", "admin"),
            ("aram", "usuario", "fglpc2@gmail.com", "Felipe", None, "013025086123", "13/02/2006", "123", "Rua luis porrio, 415", "admin"),
            ("aaa", "usuario", "fglpc2@gmail.com", "Felipe", None, "013025086123", "13/02/2006", "123", "Rua luis porrio, 415", "admin"),
            ("filho", "usuario", "fglpc2@gmail.com", "Felipe", None, "013025086123", "13/02/2006", "123", "Rua luis porrio, 415", "admin"),
                        ...
                        match indice:
                            ...
                            case "9":
                                ...
                                while not permitido:
                                    for user in self.database:
                                        if usuario != self.usuarioLogado:
                                            permitidoUserLogado = verificarPermissao(self.database, self.usuarioLogado)
                                            permitidoUserEditado = verificarPermissao(self.database, usuario)
                                            ...
                                            raise Exception("Você não pode mudar suas proprias permissões")
                                roleValida = False
        ...
        if len(self.database) >= 1:
            ...
            while not usuarioValido:   
                ...
                while not indiceValido:                        
                    ...
                    indice = str(input("Informe o indice do usuario que deseja atualizar: ")).strip().lower()
                ...
                while not loginEscolhido:
                    ...
                    match choice:
                        ...
                        case "2":
                            ...
                            while not loginValido:
                                self.bannerCadastro()
                                login = str(input("Informe o usuario: ")).strip().lower()
                                loginValido = validarLogin(login, choice)
                                tipoLogin = "usuario"
                                if not loginValido:
                                    input("APERTE ENTER PARA CONTINUAR:")
                    ...
                    if not verificarSeTodosAdmin(self.database):
                        ...
                        while not usuarioDeletado:
                            ...
                            while not indiceValido:
                                self.bannerDeletarUsuarios()
                                mostrarUsuarios(self.database)
                                indice = str(input("Informe o indice do usuario que deseja deletar: "))
                                indiceValido = validarIndice(self.database, indice)
                                if not indiceValido:
                                    input("APERTE ENTER PARA CONTINUAR")
                            usuario = self.database[int(indice) -1]
                            ...
                            print("Deletando...")
                            sleep(1)
                            usuarioDeletado = deletarUsuario(self.database, usuario[0], self.usuarioLogado)
                            if not usuarioDeletado:
                                input("APERTE ENTER PARA CONTINUAR")
                        print(f'o usuario "{usuario[0]}" foi deletado com sucesso')
                    else:
                        self.bannerDeletarUsuarios()
                        print("Todos os usuarios encontrados são admin, não é possivel remover!")
        else:
